...
import userImg from '../media/user-1.jpg';
    ...
    <div className="header">
        ...
        <nav className="user-nav">
            <div className="user-nav__icon-box">
                <svg className="user-nav__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
            ...
            <div className="user-nav__user">
                ...
                <span className="user-nav__user-name">Joe Dierte</span>
            </div>
        </nav>
    </div>
);
